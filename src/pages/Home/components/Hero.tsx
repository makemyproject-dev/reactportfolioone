	...
	return (
		<>
			<div className="mx-auto max-w-7xl">
				<div
					...
					<div className="py-12 sm:py-12 md:py-18 lg:py-24">
						<div>
							<svg className="size-9 sm:size-9 md:size-12 lg:size-16 hover:animate-wiggle" viewBox="0 0 24 24" fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<path opacity="0.5" d="M8.7838 21.9999C7.0986 21.2478 5.70665 20.0758 4.79175 18.5068" stroke="#111111"
									strokeWidth="1.5" strokeLinecap="round" />
								<path opacity="0.5" d="M14.8252 2.18595C16.5021 1.70882 18.2333 2.16305 19.4417 3.39724" stroke="#111111"
									strokeWidth="1.5" strokeLinecap="round" />
								<path
						...
						<div className="flex flex-col mt-4 sm:mt-4 md:mt-6 lg:mt-8 flex-nowrap whitespace-nowrap">
							<span className="text-4xl md:text-5xl lg:text-7xl font-light">Hello!</span>
							<span className="text-4xl md:text-5xl lg:text-7xl font-bold">I'm John Doe</span>
						</div>
						<div className="flex items-center justify-start gap-4 mt-4 sm:mt-4 md:mt-6 lg:mt-8">
							<hr className="border border-gray-500 w-1/3" />
							<div className="text-xl md:text-3xl flex-nowrap whitespace-nowrap">Web Developer</div>
							<div>
						...
						<div className="mt-4 sm:mt-4 md:mt-6 lg:mt-8">
							Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptates dolores eum est ipsum
							laborum ratione, earum placeat possimus optio et!
						</div>
						<div className="mt-12 sm:mt-12 md:mt-16 lg:mt-21">
						...
						<div className="flex items-center gap-8 mt-6 sm:mt-6 md:mt-8 lg:mt-12">
							<button
								className="px-6 py-4 bg-gray-900 border border-gray-50 hover:bg-gray-50 hover:text-gray-800 transition-all duration-150 hover:border hover:border-gray-900 text-white text-lg font-semibold cursor-pointer">
								Let's talk
							</button>
							<div className="flex border-b border-gray-400 cursor-pointer text-lg font-semibold gap-2 group">
			...
			<div className="bg-black py-5">
				<div className="mx-auto max-w-7xl flex flex-wrap justify-between text-2xl text-white gap-4">
					<div className="flex w-full lg:w-2/5 justify-center lg:justify-between">
						<span className="text-nowrap"> Web Design </span>
						<svg className="shrink-0" width="40px" height="40px" viewBox="0 0 24 24" fill="none"
							xmlns="http://www.w3.org/2000/svg">
							<path
								d="M12 3C12 7.97056 16.0294 12 21 12C16.0294 12 12 16.0294 12 21C12 16.0294 7.97056 12 3 12C7.97056 12 12 7.97056 12 3Z"
					...
					<svg className="hidden lg:block shrink-0" width="40px" height="40px" viewBox="0 0 24 24" fill="none"
						xmlns="http://www.w3.org/2000/svg">
						<path
							d="M12 3C12 7.97056 16.0294 12 21 12C16.0294 12 12 16.0294 12 21C12 16.0294 7.97056 12 3 12C7.97056 12 12 7.97056 12 3Z"
							fill="currentColor" strokeWidth="1.5" strokeLinecap="round" stroke-linejoin="round" />
